...
private:
    ...
    static std::vector<cv::Point> FindLargestContour(const cv::Mat& image, bool includeInteriorPoints, int persp);
    ...
    static vtkSmartPointer<vtkPolyData> ExtractLargestContourFromSlice(vtkSmartPointer<vtkImageData> slice, int persp);
...
public:
    ...
    static vtkSmartPointer<vtkPolyData> ProcessAxialSliceForContours(vtkSmartPointer<vtkImageData> axialSlice);
